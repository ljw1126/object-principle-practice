...
public class MonthlyPlanTest {
    ...
    @ParameterizedTest(name = "{0}번째 {1}가 {2}일 때 includes는 true를 반환해야 한다")
    @CsvSource({
        "1, MONDAY, 2024-10-07", // 1번째 월요일이 7일인 경우
        "2, MONDAY, 2024-10-14", // 2번째 월요일이 14일인 경우
        "3, MONDAY, 2024-10-21", // 3번째 월요일이 21일인 경우
